...
const demo = await readFile(resolve(root, "demo/index.html"), "utf8");
if (!demo.includes("tablemate-teacher-evidence.mp4") || !demo.includes("Evidence boundary")) {
  throw new Error("Product demo is missing its evidence video or boundary statement");
}
