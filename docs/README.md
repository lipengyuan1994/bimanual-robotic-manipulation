...
Read [STATUS](STATUS.md) first when resuming work.

| Need | Source of truth |
|---|---|
| Accepted outcome and scope | [Plan](PLAN.md) |
| Implemented vs pending | [Status](STATUS.md), [machine-readable status](project.json) |
| Work order and acceptance | [Roadmap](ROADMAP.md) |
| Official requirements vs internal targets | [Requirements](REQUIREMENTS.md) |
...
| Beginner curriculum | [Learning path](LEARNING.md) |
| Public learning website | [GitHub Pages operations](GITHUB_PAGES.md) |
