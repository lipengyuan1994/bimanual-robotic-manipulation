...
remains teacher data only; retraining and learned success are still unproven. Distinct plate source `approach_contact-51006` completed as `six-skill-corrective-f897acf5ff2f7761f9bbfa62`, manifest `801b187dbd802ef4ff010866d05517d45366e5ffa235776a8cb4643be13b1684`: it recorded a 2,099-action prefix, two measured-state actions, and 769 replay actions with 2,871 synchronized observations, independently scoring physical plate placement. Frozen [`experiments/six-skill-corrective-views-v4.json`](experiments/six-skill-corrective-views-v4.json), seal `6e7b2d50e622edcadf3796a85ab96e64bc2d179948cbca90b69282a918ff3df8`, binds the four replays (2,330 transitions). Foreground exports were interrupted before a manifest could be written, so their incomplete artifacts remain preserved and are not training inputs. The fork case `approach_contact-51007` completed after its longer live collection as `six-skill-corrective-2ef5d7aeac2f58e89858a6d9`, manifest `ff319459a340235682095a51f70c071f46e2f40fd29ab3e6f41cf0d8b74263b9`: its 650-action replay and 4,998 synchronized observations independently score fork placement as succeeded. Frozen [`experiments/six-skill-corrective-views-v5.json`](experiments/six-skill-corrective-views-v5.json), seal `416f41289c4676cda8c19fa2b180dfe00b1120efc5b28362019362775d797e8a`, independently binds five replays totaling 2,980 transitions. These remain teacher data only. Spoon case `grasp_lift-51010` completed as `six-skill-corrective-a8e2df6c5b1fc7f74b7de57a`, manifest `bae2ffee5e888db6d064a7411e14ae7d37c92acae242a41788248c9ee22e5de5`, with a 650-action replay and 4,294 synchronized observations; its independently checked v6 view adds that replay. Drawer case `drawer_pull-51015` completed as `six-skill-corrective-5b5e7e22ac21225a79d115fd`, manifest `2cde365ece8ee5051c706ba0154b54ecde492ae66a46ea179ce87d4616c14130`, with a 513-action replay and 3,597 synchronized observations; independent scoring confirms contact-driven opening and release with no artificial attachment or object-state edit. Frozen [`experiments/six-skill-corrective-views-v7.json`](experiments/six-skill-corrective-views-v7.json), seal `6af40e2dcea7c43541e518f447039beb3a88cf16fe872748835383d8ef86a08f`, independently binds all seven validated replays for 4,143 transitions and covers every first-release skill (including both bar cases). This is corrective teacher data only: it has not retrained or promoted a policy, and learned manipulation success remains unproven. The native offline export at `.artifacts/datasets/six-skill-corrective-all-v1` is now independently verified against that v7 view: it retains all seven raw sealed sources, 4,143 decoded image-backed LeRobot v0.6.1 transitions and the exact view copy. Export manifest seal `588e701aa3cd8e7e6101d6c227b9a98ecd915643f5851152bc7efd6d27a00668`. The shared archive is storage only: training reloads its sealed view and permits each skill only its matching replay sources, rejecting an empty or substituted selection. This remains teacher data only; no corrective checkpoint has trained or been promoted. The corrective cohort is now frozen at [`experiments/six-skill-corrective-training-protocol-v1.json`](experiments/six-skill-corrective-training-protocol-v1.json), seal `63ff439f807ddf13d49aef1ebdd2d1dd4da05f0ef9f0a85ea94fb8b3856051e5`. It binds the nominal dataset, nominal skill views, the five historical prerequisite records, and the independently verified all-skill corrective archive (export seal `588e701aa3cd8e7e6101d6c227b9a98ecd915643f5851152bc7efd6d27a00668`). It requires each of the six 20,000-update native-MPS ACT runs to select only corrective replay sources belonging to its own skill. The protocol and inputs were independently revalidated after it was written. This authorizes no execution by itself and makes no learned-quality claim. The next executable step is one serial local corrective training run for `bar_place_and_return`; inspect its sealed result before beginning another model job. Intel setup remains deferred until the local retraining and evaluation work completes.
